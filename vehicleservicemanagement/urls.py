...
from vehicle.views import admin_garage_view
...
urlpatterns = [
    ...
    path('admin-garage/', views.admin_garage_view, name='admin_garage'),
    ...
    path('admin-garage-view/', views.admin_garage_view, name='admin_garage_view'),
    path('admin-view-garage/', views.admin_view_garage, name='admin_view_garage'),
    path('admin-add-garage/', views.admin_add_garage, name='admin_add_garage'),
    path('admin-approve-garage/<int:garage_id>/', views.admin_approve_garage, name='admin_approve_garage'),
    path('admin-garage-attendance/<int:garage_id>/', views.admin_garage_attendance, name='admin_garage_attendance'),
    path('edit-garage/<int:id>/', views.edit_garage, name='admin-edit-garage'),
    ...
    path('vehicles/awaiting-inspection/', views.vehicles_awaiting_inspection, name='vehicles_awaiting_inspection'),
    path('vehicles/register/', views.vehicle_registration_form, name='vehicle_registration_form'),
    path('vehicles/approved-for-repair/', views.vehicles_approved_for_repair, name='vehicles_approved_for_repair'),
    path('vehicles/department-summary/', views.department_vehicle_summary, name='department_vehicle_summary'), 
]
